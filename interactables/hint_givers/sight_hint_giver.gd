...
func set_cooldown() -> void:
	var new_base := base_cd - player_stats.sight_cd_bonus - player_stats.universal_cd_bonus
	var multipliers := player_stats.sight_cd_multipliers + player_stats.universal_cd_multipliers
